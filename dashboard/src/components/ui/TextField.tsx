...
export function TextField({
  ...
  return (
    <div className={clsx('space-y-2', containerClassName)}>
      <label htmlFor={inputId} className="block text-base font-normal tracking-tight text-gray-900">
        {label}
      </label>
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-3">
            {showPasswordToggle ? (
              <button
                ...
                className="ui-hover-icon inline-flex items-center justify-center text-gray-400 hover:text-primary-600 transition-colors duration-200 ease-out focus:outline-none focus-visible:text-primary-600 focus-visible:ring-2 focus-visible:ring-primary-500 focus-visible:ring-offset-1 rounded-md origin-center"
              ...
              <button
                type="button"
                onClick={onClear}
                className="ui-hover-icon inline-flex items-center justify-center text-gray-400 hover:text-red-500 transition-colors duration-200 ease-out focus:outline-none focus-visible:text-red-500 focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:ring-offset-1 rounded-md origin-center"
